...
public:
  ...
  void
  SetRecordName (std::string rName)
  {
    m_recordName = rName;
  }
  std::string
  GetRecordName (void) const
  {
    return m_recordName;
  }
